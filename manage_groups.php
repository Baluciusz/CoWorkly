...
<body>
    <div class="wrapper">
        ...
        <div class="table-container">
            ...
            <button class="back-button" onclick="window.location.href='admin_dashboard.php'">Dashboard</button><br><br>
            <button class="back-button" onclick="window.location.href='status_check.php'">Oldalak státuszai</button><br><br>
